...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Chonkwatch2019 web application."
  #
  #
  ...
  #
  # settings.secret_key_base= xsP_VtR8sEIJaVGGa6G-70Y0-t2p0YIoWum603FEcCo
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("chonkwatch2019.log", "w"))
  #
  #
end
